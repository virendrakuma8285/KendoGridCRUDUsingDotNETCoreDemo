...
import { Component, ChangeDetectionStrategy, ContentChild, EventEmitter, ElementRef, Renderer2, isDevMode, forwardRef, HostBinding, HostListener, Input, Output, ViewChild } from '@angular/core';
...
var CalendarComponent = (function () {
    function CalendarComponent(bus, dom, element, navigator, renderer, scrollSyncService) {
        this.bus = bus;
        this.dom = dom;
