...
import { Component, ChangeDetectionStrategy, ChangeDetectorRef, Input, Output, ViewChild, EventEmitter, HostBinding, HostListener, isDevMode, Renderer2, forwardRef } from '@angular/core';
...
var DateInputComponent = (function () {
    function DateInputComponent(cdr, intl, renderer, localization) {
        this.cdr = cdr;
        this.intl = intl;
