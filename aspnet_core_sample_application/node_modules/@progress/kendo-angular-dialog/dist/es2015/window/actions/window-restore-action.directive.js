import { Directive, HostListener, ElementRef, Renderer2, Optional, Inject, HostBinding, Input } from "@angular/core";
import { DragResizeService } from './../drag-resize.service';
import { Button } from '@progress/kendo-angular-buttons';
import { RTL } from '@progress/kendo-angular-l10n';
export class WindowRestoreActionDirective extends Button {
    constructor(el, renderer, _service, rtl) {
        super(el, renderer, null, rtl);
