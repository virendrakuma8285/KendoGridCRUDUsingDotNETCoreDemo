...
export class DragResizeService {
    ...
    storeOptions() {
        ...
        if (!isPresent(this.options.width) || !isPresent(this.options.height)) {
            const currentOffset = offset(this.window.nativeElement);
    ...
    maximizeAction() {
        ...
        this.storeOptions();
        const wnd = getWindowViewPort(this.window.nativeElement);
    ...
    center() {
        ...
        let wnd = getWindowViewPort(this.window.nativeElement);
