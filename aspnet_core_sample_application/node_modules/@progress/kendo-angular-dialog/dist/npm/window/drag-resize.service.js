...
var DragResizeService = /** @class */ (function () {
    ...
    DragResizeService.prototype.storeOptions = function () {
        this.restoreOptions = Object.assign({}, this.options);
        if (!util_1.isPresent(this.options.width) || !util_1.isPresent(this.options.height)) {
            var currentOffset = kendo_popup_common_1.offset(this.window.nativeElement);
    ...
    DragResizeService.prototype.maximizeAction = function () {
        ...
        this.storeOptions();
        var wnd = kendo_popup_common_1.getWindowViewPort(this.window.nativeElement);
