import { ElementRef, EventEmitter, ViewContainerRef, TemplateRef, OnDestroy, SimpleChange, OnChanges, ChangeDetectorRef } from '@angular/core';
...
export declare class AutoCompleteComponent implements ControlValueAccessor, OnDestroy, OnChanges {
     ...
     *
     * For more details, refer to the example on [events]({% slug overview_autocomplete_kendouiforangular %}#toc-events).
     */
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, cdr: ChangeDetectorRef, wrapper: ElementRef);
    ngOnDestroy(): void;
