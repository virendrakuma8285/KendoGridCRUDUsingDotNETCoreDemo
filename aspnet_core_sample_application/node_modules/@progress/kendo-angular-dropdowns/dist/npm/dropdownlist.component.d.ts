import { ElementRef, EventEmitter, ViewContainerRef, OnDestroy, OnChanges, SimpleChange, NgZone, TemplateRef, ChangeDetectorRef } from '@angular/core';
...
export declare class DropDownListComponent implements ControlValueAccessor, OnDestroy, OnChanges {
     ...
     * [`valuePrimitive`]({% slug valuebinding_ddl_kendouiforangular %}#toc-primitive-values-from-object-fields) property.
     */
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, _zone: NgZone, cdr: ChangeDetectorRef);
    /**
     * @hidden
     */
    onFilterFocus(): void;
